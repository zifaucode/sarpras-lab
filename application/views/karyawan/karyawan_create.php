<div class="row">
    <div class="col-lg-12"><br />
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url('karyawan/create'); ?>">Guru</a></li>
            <li class="active">Buat Data Guru</li>
        </ol>
        ...
        <div class="panel panel-default">
            ...
            <?php echo form_open_multipart('karyawan/insert', array('class' => 'form-horizontal', 'id' => 'jvalidate')) ?>
                ...
                <div class="form-group">
                    <p class="col-sm-2 text-left">NIP/NUPTK </p>

                    <div class="col-sm-10">
                        <input type="text" name="nik" class="form-control" placeholder="NIP/NUPTK" value="<?php echo set_value('nik'); ?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <p class="col-sm-2 text-left">Jabatan </p>
