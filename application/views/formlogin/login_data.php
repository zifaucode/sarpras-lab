...
<body>
    <div class="navbar navbar-default">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo site_url('');?>"><strong>LABKOM SMAN 1 PARUNG</strong></a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="<?php echo site_url('login');?>"><i class="glyphicon glyphicon-home"></i> Home</a></li>
                <li><a href="<?php echo site_url('login/view_karyawan');?>"><i class="glyphicon glyphicon-user"></i> Petugas</a></li>
            </ul>
...
<div class="row">
    ...
    <div class="col-md-8 ">
        <h4 align="center">inventaris Labkom</h4><hr class="line-title"> 
        <img src="<?php echo base_url(); ?>assets/img/banner/logo_atas.png" alt="Belum Tersedia" class="img-responsive">
    </div>
</div>
</div>
